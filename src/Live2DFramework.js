...
var texCounter = 0;
L2DBaseModel.prototype.getModelMatrix = function() { return this.modelMatrix; }
L2DBaseModel.prototype.setAlpha = function(a) { if( a > 0.999 ) a = 1; if( a < 0.001 ) a = 0; this.alpha = a; }
L2DBaseModel.prototype.getAlpha = function() { return this.alpha; }
L2DBaseModel.prototype.isInitialized = function() { return this.initialized; }
L2DBaseModel.prototype.setInitialized = function(v) { this.initialized = v; }
L2DBaseModel.prototype.isUpdating = function() { return this.updating; }
L2DBaseModel.prototype.setUpdating = function(v) { this.updating = v; }
L2DBaseModel.prototype.getLive2DModel = function() { return this.live2DModel; }
L2DBaseModel.prototype.setLipSync = function(v) { this.lipSync = v; }
L2DBaseModel.prototype.setLipSyncValue = function(v) { this.lipSyncValue = v; }
L2DBaseModel.prototype.setAccel = function(x, y, z) { this.accelX = x; this.accelY = y; this.accelZ = z; }
L2DBaseModel.prototype.setDrag = function(x, y) { this.dragX = x; this.dragY = y; }
L2DBaseModel.prototype.getMainMotionManager = function() { return this.mainMotionManager; }
L2DBaseModel.prototype.getExpressionManager = function() { return this.expressionManager; }
...
L2DBaseModel.prototype.loadExpression = function(name, path, callback)
{
    ...
    var thisRef = this;
    pm.loadBytes(path, function(buf) {
        if(name != null) thisRef.expressions[name] = L2DExpressionMotion.loadJson(buf);
        if (typeof callback == "function") callback();
    });
}
...
L2DBaseModel.prototype.loadPose = function( path, callback )
{
    ...
    var thisRef = this;
    try {
        pm.loadBytes(path, function(buf) { thisRef.pose = L2DPose.load(buf); if (typeof callback == "function") callback(); });
...
L2DBaseModel.prototype.loadPhysics = function(path)
{
    ...
    var thisRef = this;
    try {
        pm.loadBytes(path, function(buf) { thisRef.physics = L2DPhysics.load(buf); });
    } catch(e) { console.warn(e); }
}
...
L2DExpressionMotion.loadJson = function(buf)
{
    ...
    if(json.params == null) return ret;
...
function L2DMatrix44() { this.tr = new Float32Array(16); this.identity(); }
...
L2DMatrix44.prototype.getArray = function() { return this.tr; }
L2DMatrix44.prototype.getCopyMatrix = function() { return new Float32Array(this.tr); }
...
L2DMatrix44.prototype.getScaleX = function() { return this.tr[0]; }
L2DMatrix44.prototype.getScaleY = function() { return this.tr[5]; }
L2DMatrix44.prototype.transformX = function(src) { return this.tr[0] * src + this.tr[12]; }
L2DMatrix44.prototype.transformY = function(src) { return this.tr[5] * src + this.tr[13]; }
L2DMatrix44.prototype.invertTransformX = function(src) { return ( src - this.tr[12] ) / this.tr[0]; }
L2DMatrix44.prototype.invertTransformY = function(src) { return ( src - this.tr[13] ) / this.tr[5]; }
...
L2DMatrix44.prototype.translate = function(x, y) { this.tr[12] = x; this.tr[13] = y; }
L2DMatrix44.prototype.translateX = function(x) { this.tr[12] = x; }
L2DMatrix44.prototype.translateY = function(y) { this.tr[13] = y; }
...
L2DMatrix44.prototype.scale = function(scaleX, scaleY) { this.tr[0] = scaleX; this.tr[5] = scaleY; }
function L2DModelMatrix(w, h) { L2DMatrix44.prototype.constructor.call(this); this.width = w; this.height = h; }
L2DModelMatrix.prototype = new L2DMatrix44();
L2DModelMatrix.prototype.setPosition = function(x, y) { this.translate(x, y); }
...
L2DModelMatrix.prototype.top = function(y) { this.setY(y); }
L2DModelMatrix.prototype.bottom = function(y) { var h = this.height * this.getScaleY(); this.translateY(y - h); }
L2DModelMatrix.prototype.left = function(x) { this.setX(x); }
L2DModelMatrix.prototype.right = function(x) { var w = this.width * this.getScaleX(); this.translateX(x - w); }
L2DModelMatrix.prototype.centerX = function(x) { var w = this.width * this.getScaleX(); this.translateX(x - w / 2); }
L2DModelMatrix.prototype.centerY = function(y) { var h = this.height * this.getScaleY(); this.translateY(y - h / 2); }
L2DModelMatrix.prototype.setX = function(x) { this.translateX(x); }
L2DModelMatrix.prototype.setY = function(y) { this.translateY(y); }
L2DModelMatrix.prototype.setHeight = function(h) { var scaleX = h / this.height; var scaleY = -scaleX; this.scale(scaleX, scaleY); }
L2DModelMatrix.prototype.setWidth = function(w) { var scaleX = w / this.width; var scaleY = -scaleX; this.scale(scaleX, scaleY); }
...
L2DMotionManager.prototype.getCurrentPriority = function() { return this.currentPriority; }
L2DMotionManager.prototype.getReservePriority = function() { return this.reservePriority; }

L2DMotionManager.prototype.reserveMotion = function(priority)
{
    if(this.reservePriority >= priority) return false;
    if(this.currentPriority >= priority) return false;
    this.reservePriority = priority;
    return true;
}

L2DMotionManager.prototype.setReservePriority = function(val) { this.reservePriority = val; }
...
L2DMotionManager.prototype.updateParam = function(model)
{
    ...
    if(this.isFinished()) this.currentPriority = 0;
    return updated;
}

L2DMotionManager.prototype.startMotionPrio = function(motion, priority)
{
    if(priority == this.reservePriority) this.reservePriority = 0;
...
function L2DPose() { this.lastTime = 0; this.lastModel = null; this.partsGroups = new Array(); }
...
L2DPose.prototype.updateParam = function(model)
{
    ...
    if(!(model == this.lastModel)) this.initParam(model);
...
L2DTargetPoint.prototype.setPoint = function(x, y) { this.faceTargetX = x; this.faceTargetY = y; }
L2DTargetPoint.prototype.getX = function() { return this.faceX; }
L2DTargetPoint.prototype.getY = function() { return this.faceY; }
...
L2DTargetPoint.prototype.update = function()
{
    ...
    if(this.lastTimeSec == 0) { this.lastTimeSec = UtSystem.getUserTimeMSec(); return; }
    ...
    if(a < -MAX_A || a > MAX_A) { ax *= MAX_A / a; ay *= MAX_A / a; a = MAX_A; }
    this.faceVX += ax;
    this.faceVY += ay;
    ...
    if(cur_v > max_v) { this.faceVX *= max_v / cur_v; this.faceVY *= max_v / cur_v; }
...
L2DViewMatrix.prototype.getMaxScale = function() { return this.max; }
L2DViewMatrix.prototype.getMinScale = function() { return this.min; }
L2DViewMatrix.prototype.setMaxScale = function(v) { this.max = v; }
L2DViewMatrix.prototype.setMinScale = function(v) { this.min = v; }
L2DViewMatrix.prototype.isMaxScale = function() { return this.getScaleX() == this.max; }
L2DViewMatrix.prototype.isMinScale = function() { return this.getScaleX() == this.min; }
...
L2DViewMatrix.prototype.getScreenLeft = function() { return this.screenLeft; }
L2DViewMatrix.prototype.getScreenRight = function() { return this.screenRight; }
L2DViewMatrix.prototype.getScreenBottom = function() { return this.screenBottom; }
L2DViewMatrix.prototype.getScreenTop = function() { return this.screenTop; }
L2DViewMatrix.prototype.getMaxLeft = function() { return this.maxLeft; }
L2DViewMatrix.prototype.getMaxRight = function() { return this.maxRight; }
L2DViewMatrix.prototype.getMaxBottom = function() { return this.maxBottom; }
L2DViewMatrix.prototype.getMaxTop = function() { return this.maxTop; }

function Live2DFramework() { }
Live2DFramework.platformManager = null;
Live2DFramework.getPlatformManager = function() { return Live2DFramework.platformManager; }
Live2DFramework.setPlatformManager = function(platformManager) { Live2DFramework.platformManager = platformManager; }
