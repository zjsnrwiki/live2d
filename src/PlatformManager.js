...
{
    this.loadBytes(path, function(buf) { return buf; });
}
...
{ 
    ...
    loadedImage.onerror = function() { console.error("Failed to load image : " + path); }
}
...
PlatformManager.prototype.log = function(txt) { console.log(txt); }
